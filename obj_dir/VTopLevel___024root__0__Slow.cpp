...
VL_ATTR_COLD void VTopLevel___024root___ctor_var_reset(VTopLevel___024root* vlSelf) {
    ...
    vlSelf->TopLevel__DOT__wdata1IM = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 8086508758111379005ull);
    vlSelf->TopLevel__DOT__wdata2RE = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 1306039931419811927ull);
    vlSelf->TopLevel__DOT__wdata2IM = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 2365371080191259613ull);
    ...
    vlSelf->TopLevel__DOT__waddr1PP = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 12726356571783613367ull);
    vlSelf->TopLevel__DOT__waddr2 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 5255309094146332745ull);
    vlSelf->TopLevel__DOT__raddr1 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 14809967837069742261ull);
    vlSelf->TopLevel__DOT__raddr2 = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 14241782945361508953ull);
    ...
    vlSelf->TopLevel__DOT__PP1__DOT__transCompRW = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6213308371851047109ull);
    vlSelf->TopLevel__DOT__PP1__DOT__transCompWR = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3355958156568564451ull);
    vlSelf->TopLevel__DOT__PP1__DOT__fftComp = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1678607882154984959ull);
