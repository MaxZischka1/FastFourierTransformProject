...
VL_ATTR_COLD void VSBM16___024root__trace_init_sub__TOP__0(VSBM16___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+8,0,"d1InRE",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+9,0,"d1InIM",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+10,0,"WInRE",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+11,0,"WInIM",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+12,0,"d2InRE",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+13,0,"d2InIM",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+14,0,"dOutEvIM",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+15,0,"dOutEvRE",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+16,0,"dOutOddIM",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+17,0,"dOutOddRE",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->popPrefix();
    ...
    tracep->declBus(c+5,0,"sumEvRE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 16,0);
    tracep->declBus(c+6,0,"sumEvIM",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 16,0);
    tracep->declBus(c+18,0,"sumOddRE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 16,0);
    tracep->declBus(c+19,0,"sumOddIM",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 16,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void VSBM16___024root__trace_const_0_sub_0(VSBM16___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+18,(vlSelfRef.SBM16__DOT__sumOddRE),17);
    bufp->fullIData(oldp+19,(vlSelfRef.SBM16__DOT__sumOddIM),17);
}
...
VL_ATTR_COLD void VSBM16___024root__trace_full_0_sub_0(VSBM16___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+5,(vlSelfRef.SBM16__DOT__sumEvRE),17);
    bufp->fullIData(oldp+6,(vlSelfRef.SBM16__DOT__sumEvIM),17);
    bufp->fullBit(oldp+7,(vlSelfRef.clk));
    bufp->fullSData(oldp+8,(vlSelfRef.d1InRE),16);
    bufp->fullSData(oldp+9,(vlSelfRef.d1InIM),16);
    bufp->fullSData(oldp+10,(vlSelfRef.WInRE),16);
    bufp->fullSData(oldp+11,(vlSelfRef.WInIM),16);
    bufp->fullSData(oldp+12,(vlSelfRef.d2InRE),16);
    bufp->fullSData(oldp+13,(vlSelfRef.d2InIM),16);
    bufp->fullIData(oldp+14,(vlSelfRef.dOutEvIM),32);
    bufp->fullIData(oldp+15,(vlSelfRef.dOutEvRE),32);
    bufp->fullIData(oldp+16,(vlSelfRef.dOutOddIM),32);
    bufp->fullIData(oldp+17,(vlSelfRef.dOutOddRE),32);
}
