...
VL_ATTR_COLD void VSBM16___024root__trace_init_sub__TOP__0(VSBM16___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+8,0,"dataOutRE",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+9,0,"dataOutIM",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->popPrefix();
...
VL_ATTR_COLD void VSBM16___024root__trace_full_0_sub_0(VSBM16___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+8,(vlSelfRef.dataOutRE),16);
    bufp->fullSData(oldp+9,(vlSelfRef.dataOutIM),16);
